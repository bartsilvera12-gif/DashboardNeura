...
export const PRODUCT_COLUMN_DEFINITIONS: Array<{
  ...
  { key: "image", label: "Imagen URL (legacy)", section: "catalogo", type: "text", default_visible: false, default_editable: true, default_required: false, affects_stock: false, affects_dashboard: false },
  { key: "images", label: "Imágenes (URLs)", section: "catalogo", type: "image_urls_multi", default_visible: true, default_editable: true, default_required: false, affects_stock: false, affects_dashboard: false },
